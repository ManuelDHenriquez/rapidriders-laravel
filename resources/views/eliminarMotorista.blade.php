    ...
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-md-12 titulo">
                <h1 class="my-4">Eliminar Motorista</h1>
            </div>
        </div>

        <div class="col-md-12">
            <h1>Desea eliminar este Motorista?</h1>

            <form action="{{ route('motoristas.delete', $id) }}" method="post" class="text-center">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-danger"><i class="fa-solid fa-user-xmark"></i> Eliminar</button>

                <a
                  href="{{ route('motoristas.motoristas') }}"
