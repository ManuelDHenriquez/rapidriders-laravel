    ...
    <div class="container-fluid">
        <div class="row text-center">
            <div class="col-md-12 titulo">
                <h1 class="my-4">Eliminar Comercio</h1>
            </div>
        </div>

        <div class="col-md-12">
            <h1>Desea eliminar este Comercio?</h1>

            <form action="{{ route('comercios.delete', $id) }}" method="post" class="text-center">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-danger"><i class="fa-solid fa-user-xmark"></i> Eliminar</button>

                <a href="{{ route('comercios.comercios') }}" class="btn btn-primary"><i class="fa-solid fa-ban"></i> Cancelar</a>
            </form>
        </div>
    </div>
</body>
